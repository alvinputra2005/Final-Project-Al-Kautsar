...
// Rute untuk halaman admin (Manajemen Ulasan)
Route::get('admin/ulasan', [UlasanController::class, 'index'])->name('admin.ulasan.index'); // Daftar Ulasan untuk admin
...
// Rute untuk halaman pengguna biasa (Melihat dan menambah ulasan)
Route::get('ulasan', [UlasanController::class, 'index2'])->name('ulasan.index2'); // Daftar Ulasan untuk semua orang
Route::get('ulasan/create', [UlasanController::class, 'create'])->name('ulasan.create'); // Form tambah ulasan
