...
// Rute untuk Alumni
Route::get('admin/alumnis', [AlumnisController::class, 'index'])->name('admin.alumnis.index'); // Daftar alumni untuk admin
Route::get('admin/alumnis/create', [AlumnisController::class, 'create'])->name('admin.alumnis.create'); // Form tambah alumni
Route::post('admin/alumnis', [AlumnisController::class, 'store'])->name('admin.alumnis.store'); // Proses tambah alumni
Route::get('admin/alumnis/{id}/edit', [AlumnisController::class, 'edit'])->name('admin.alumnis.edit'); // Form edit alumni
Route::put('admin/alumnis/{id}', [AlumnisController::class, 'update'])->name('admin.alumnis.update'); // Update alumni
Route::delete('admin/alumnis/{id}', [AlumnisController::class, 'destroy'])->name('admin.alumnis.destroy'); // Hapus alumni
