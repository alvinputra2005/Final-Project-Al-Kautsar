...
@section('content')
    <div class="container mt-4">
        <h2 style="font-size: 30px; font-weight: bold; color: black;">Dashboard Admin</h2> <!-- Mengubah ukuran dan warna teks "Dashboard Admin" -->
        ...
        <div class="dashboard-info">
            ...
            <div class="card">
                <h3>Total Ulasan</h3>
                 <p>{{ $ulasanCount }}</p> <!-- Menampilkan jumlah ulasan dari database -->
            </div>

            <!-- Total Alumni -->
            <div class="card">
                <h3>Total Alumni</h3>
                <p>{{ $alumniCount }}</p> <!-- Menampilkan jumlah alumni dari database -->
            </div>
    ...
    <style>
        ...
        h2 {
            font-size: 30px; /* Ukuran font lebih besar untuk Dashboard Admin */
            font-weight: bold;
