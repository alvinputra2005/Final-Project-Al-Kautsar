...
<head>
    ...
    <style>
        ...
        .sidebar {
            position: sticky; /* Sidebar tetap di posisi kiri saat di-scroll */
            top: 0; /* Membuatnya tetap di atas */
            ...
            padding-top: 20px;
            padding-right: 10px;
            overflow-y: auto; /* Agar sidebar bisa digulir jika konten melebihi tinggi layar */
        }
