...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/tendik.css') }}">
</head>
<body>
...
<header class="title-section">  
  ...
  <a href="{{ url('/') }}#statistik" class="back-button">&larr; Kembali ke Beranda Utama</a>
</header>
...
<main>
      ...
      <div class="flip-card-inner">
        <div class="flip-card-front">
          ...
          <div class="card-image-wrapper">
            <img src="{{ asset('images/' . $tendik['image']) }}" alt="{{ $tendik['name'] }}" class="card-img">
          </div>
          <div class="card-text">
            <h3>{{ $tendik['name'] }}</h3>
            <p>{{ $tendik['asal'] }}</p>
  ...
  <div class="photo-section">
    <div class="photo-wrapper">
      ...
      <img src="{{ asset('images/tendik.jpg') }}" alt="Foto Bersama Tendik">
    </div>
  </div>
