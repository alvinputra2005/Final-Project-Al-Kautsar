  ...
  <section id="statistik" style="scroll-margin-top: 10px;">
    ...
    <div class="stat-container">
      <div class="stat-box">
        ...
        <a href="{{ route('tendik') }}" class="btn-stat-left">Lihat Profil</a>
      </div>
      <div class="stat-box">
        <div class="icon"><i class="fas fa-user-graduate"></i></div>
        <h3 class="counter" data-target="500">65</h3>
        <p>Santri Aktif</p><br>
        <a href="{{ route('santri') }}" class="btn-stat">Data Santri</a>
      ...
      <div class="stat-box">
        ...
        <p>Alumni</p><br>
        <a href="{{ route('alumni') }}" class="btn-stat">Info Alumni</a>
      </div>
      <div class="stat-box">
      <div class="icon"><i class="fas fa-building"></i></div>
      <h3 class="counter" data-target="50">10+</h3>
      <p>Sarana Prasarana</p><br>
      <!-- Ganti link di home.blade.php -->
<a href="{{ route('sarpras') }}" class="btn-stat">Lihat Fasilitas</a>
